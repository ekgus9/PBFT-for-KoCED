...
import transformers
from transformers.modeling_bart import PretrainedBartModel, BartModel
...
from transformers.modeling_xlm_roberta import XLMRobertaForSequenceClassification, XLMRobertaModel
...
class BartForPromptFinetuning(PretrainedBartModel):
...
class XLMRobertaForPromptFinetuning(BertPreTrainedModel):
